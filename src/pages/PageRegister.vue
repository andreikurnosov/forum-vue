      ...
      <form @submit.prevent="register" action class="card card-form">
        ...
        <div class="form-group">
          ...
          <template v-if="$v.form.email.$error">
            ...
            <span v-else-if="!$v.form.email.unique" class="form-error">Sorry! This email already token</span>
          </template>
        </div>
        ...
        <div class="form-group">
          ...
          <template v-if="$v.form.avatar.$error">
            ...
            <span v-else-if="!$v.form.avatar.supportedImageFile" class="form-error">This file type is not supported by our system. <br> Supported file types: .jpg, .png, .jpeg, .svg</span>
